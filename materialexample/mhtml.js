...
function updateMHTMLObjects() {
  ...
  for(i = 0; i < fabs.length; i++) {
    fabs[i].innerHTML = '<div style="padding:21px; width:56px; height: 56px; border-radius:100%; background-color:'+materialAccentColor+'; color:'+materialTextColor+'; position:fixed; bottom:72px; right:50px;"><i class="material-icons">'+fabs[i].innerHTML+'</i></div>';
  }
