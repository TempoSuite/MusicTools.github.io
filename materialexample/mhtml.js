...
function updateMHTMLObjects() {
  ...
  for(i = 0; i < toolbars.length; i++) {
    ...
    toolbars[i].innerHTML = '<div style="width:100%; box-sizing: border-box; background-color:'+materialAccentColor+'; color:'+materialTextColor+'; font-family: \'Roboto\', sans-serif; font-weight:400; font-size: 18px; padding:21px; -webkit-box-shadow: 0px 3px 3px 0px rgba(0,0,0,0.4); -moz-box-shadow: 0px 3px 3px 0px rgba(0,0,0,0.4); box-shadow: 0px 3px 3px 0px rgba(0,0,0,0.4); position:fixed; top:0; line-height:20px;"><i onClick="openHamburger()" style="cursor:pointer; margin-right:21px;" class="material-icons">menu</i>'+toolbarTextText+'</div>';
    }
